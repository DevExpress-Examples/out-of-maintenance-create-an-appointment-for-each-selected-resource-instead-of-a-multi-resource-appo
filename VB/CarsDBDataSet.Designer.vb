...
Namespace SchedulerMultiResAppointments.CarsDBDataSetTableAdapters
    ...
    Partial Public Class CarsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Cars] ([Model], [Picture]) VALUES (@Model, @Picture);" & vbLf & "SELECT ID, Mod" & "el, Picture FROM Cars WHERE (ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Cars] SET [Model] = @Model, [Picture] = @Picture WHERE (([ID] = @Original" & "_ID) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)" & "));" & vbLf & "SELECT ID, Model, Picture FROM Cars WHERE (ID = @ID)"
