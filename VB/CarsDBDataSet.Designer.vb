...
Partial Public Class CarsDBDataSet
    ...
    Partial Public Class CarsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddCarsRow(ByVal Model As String, ByVal Picture() As Byte) As CarsRow
            Dim rowCarsRow As CarsRow = CType(Me.NewRow,CarsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Model, Picture}
    ...
    Partial Public Class CarSchedulingDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddCarSchedulingRow(ByVal CarId As String, ByVal UserId As Integer, ByVal Status As Integer, ByVal Subject As String, ByVal Description As String, ByVal Label As Integer, ByVal StartTime As Date, ByVal EndTime As Date, ByVal Location As String, ByVal AllDay As Boolean, ByVal EventType As Integer, ByVal RecurrenceInfo As String, ByVal ReminderInfo As String, ByVal Price As Decimal) As CarSchedulingRow
            Dim rowCarSchedulingRow As CarSchedulingRow = CType(Me.NewRow,CarSchedulingRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CarId, UserId, Status, Subject, Description, Label, StartTime, EndTime, Location, AllDay, EventType, RecurrenceInfo, ReminderInfo, Price}
    ...
    Partial Public Class CarSchedulingRow
        ...
        Public Property CarId() As String
            Get
                Try 
                    Return CType(Me(Me.tableCarScheduling.CarIdColumn),String)
                Catch e As Global.System.InvalidCastException
...
Namespace CarsDBDataSetTableAdapters
    ...
    Partial Public Class CarsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Cars] WHERE (([ID] = @Original_ID) AND ((@IsNull_Model = 1 AND [Mode"& _ 
                "l] IS NULL) OR ([Model] = @Original_Model)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Cars] ([Model], [Picture]) VALUES (@Model, @Picture);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Mo"& _ 
                "del, Picture FROM Cars WHERE (ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Cars] SET [Model] = @Model, [Picture] = @Picture WHERE (([ID] = @Original"& _ 
                "_ID) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)"& _ 
                "));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Model, Picture FROM Cars WHERE (ID = @ID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Settings.Default.CarsXtraSchedulingConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Model As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Model As String, ByVal Picture() As Byte) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Model As String, ByVal Picture() As Byte, ByVal Original_ID As Integer, ByVal Original_Model As String, ByVal ID As Integer) As Integer
            If (Model Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_Model,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Model As String, ByVal Picture() As Byte, ByVal Original_ID As Integer, ByVal Original_Model As String) As Integer
    ...
    Partial Public Class CarSchedulingTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [CarScheduling] WHERE (([ID] = @Original_ID) AND ((@IsNull_UserId = 1"& _ 
                " AND [UserId] IS NULL) OR ([UserId] = @Original_UserId)) AND ((@IsNull_Status = "& _ 
                "1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Subject "& _ 
                "= 1 AND [Subject] IS NULL) OR ([Subject] = @Original_Subject)) AND ((@IsNull_Lab"& _ 
                "el = 1 AND [Label] IS NULL) OR ([Label] = @Original_Label)) AND ((@IsNull_StartT"& _ 
                "ime = 1 AND [StartTime] IS NULL) OR ([StartTime] = @Original_StartTime)) AND ((@"& _ 
                "IsNull_EndTime = 1 AND [EndTime] IS NULL) OR ([EndTime] = @Original_EndTime)) AN"& _ 
                "D ((@IsNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Original_Loca"& _ 
                "tion)) AND ([AllDay] = @Original_AllDay) AND ((@IsNull_EventType = 1 AND [EventT"& _ 
                "ype] IS NULL) OR ([EventType] = @Original_EventType)) AND ((@IsNull_Price = 1 AN"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [CarScheduling] ([CarId], [UserId], [Status], [Subject], [Description"& _ 
                ...
                "ceInfo], [ReminderInfo], [Price]) VALUES (@CarId, @UserId, @Status, @Subject, @D"& _ 
                "escription, @Label, @StartTime, @EndTime, @Location, @AllDay, @EventType, @Recur"& _ 
                "renceInfo, @ReminderInfo, @Price);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, CarId, UserId, Status, Subject, D"& _ 
                "escription, Label, StartTime, EndTime, Location, AllDay, EventType, RecurrenceIn"& _ 
                "fo, ReminderInfo, Price FROM CarScheduling WHERE (ID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [CarScheduling] SET [CarId] = @CarId, [UserId] = @UserId, [Status] = @Stat"& _ 
                "us, [Subject] = @Subject, [Description] = @Description, [Label] = @Label, [Start"& _ 
                "Time] = @StartTime, [EndTime] = @EndTime, [Location] = @Location, [AllDay] = @Al"& _ 
                "lDay, [EventType] = @EventType, [RecurrenceInfo] = @RecurrenceInfo, [ReminderInf"& _ 
                "o] = @ReminderInfo, [Price] = @Price WHERE (([ID] = @Original_ID) AND ((@IsNull_"& _ 
                "UserId = 1 AND [UserId] IS NULL) OR ([UserId] = @Original_UserId)) AND ((@IsNull"& _ 
                "_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNul"& _ 
                "l_Subject = 1 AND [Subject] IS NULL) OR ([Subject] = @Original_Subject)) AND ((@"& _ 
                "IsNull_Label = 1 AND [Label] IS NULL) OR ([Label] = @Original_Label)) AND ((@IsN"& _ 
                ...
                "dTime)) AND ((@IsNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Ori"& _ 
                "ginal_Location)) AND ([AllDay] = @Original_AllDay) AND ((@IsNull_EventType = 1 A"& _ 
                "ND [EventType] IS NULL) OR ([EventType] = @Original_EventType)) AND ((@IsNull_Pr"& _ 
                "ice = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, CarId"& _ 
                ", UserId, Status, Subject, Description, Label, StartTime, EndTime, Location, All"& _ 
                "Day, EventType, RecurrenceInfo, ReminderInfo, Price FROM CarScheduling WHERE (ID"& _ 
                " = @ID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, CarId, UserId, Status, Subject, Description, Label, StartTime, EndTime"& _ 
                ", Location, AllDay, EventType, RecurrenceInfo, ReminderInfo, Price FROM CarSched"& _ 
                "uling"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_UserId As Global.System.Nullable(Of Integer), ByVal Original_Status As Global.System.Nullable(Of Integer), ByVal Original_Subject As String, ByVal Original_Label As Global.System.Nullable(Of Integer), ByVal Original_StartTime As Global.System.Nullable(Of Date), ByVal Original_EndTime As Global.System.Nullable(Of Date), ByVal Original_Location As String, ByVal Original_AllDay As Boolean, ByVal Original_EventType As Global.System.Nullable(Of Integer), ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(15).Value = CType(Original_AllDay,Boolean)
            If (Original_EventType.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(16).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(17).Value = CType(Original_EventType.Value,Integer)
            Else
            ...
            If (Original_Price.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(19).Value = CType(Original_Price.Value,Decimal)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal CarId As String, ByVal UserId As Global.System.Nullable(Of Integer), ByVal Status As Global.System.Nullable(Of Integer), ByVal Subject As String, ByVal Description As String, ByVal Label As Global.System.Nullable(Of Integer), ByVal StartTime As Global.System.Nullable(Of Date), ByVal EndTime As Global.System.Nullable(Of Date), ByVal Location As String, ByVal AllDay As Boolean, ByVal EventType As Global.System.Nullable(Of Integer), ByVal RecurrenceInfo As String, ByVal ReminderInfo As String, ByVal Price As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            If (Original_Label.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_Label.Value,Integer)
            Else
            ...
            If (Original_EndTime.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(26).Value = CType(Original_EndTime.Value,Date)
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(29).Value = CType(Original_AllDay,Boolean)
            If (Original_EventType.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(30).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(31).Value = CType(Original_EventType.Value,Integer)
            Else
